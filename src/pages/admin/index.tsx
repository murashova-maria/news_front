...
export const Admin: React.FC = () => {
  const [items] = useGlobalState("adminNews");
    ...
    <>
      ...
      <div className="adminNews">
        <div className="adminNews__block">
          ...
          <BlockAdminCard
            items={newsItems.filter((el) => el.status === "newItem")}
          />
        </div>
        <div className="adminNews__block">
          <div className="adminNews__block_title">Declined news</div>
          <BlockAdminCard
            items={newsItems.filter((el) => el.status === "declinedNews")}
          />
        </div>
        <div className="adminNews__block">
          <div className="adminNews__block_title">Published news</div>
          <BlockAdminCard
            items={newsItems.filter((el) => el.status === "publishedNews")}
          />
        </div>
      </div>
    </>
