...
import {COOKIES_ROUTE} from "../../../constants/paths";
import {NavLink} from "react-router-dom";

export const Terms: React.FC = () => {
    return (
        <div>
            The  following  describes  the  terms  and  conditions  (the  "Terms")  upon  which we offers access  to  the  Internet  site  found  at  site to you and the provision of our services.<br/><br/>

            Please  carefully  read  these  terms  of  use  (“Terms“)  as  well  as  our  privacy  policy,  which  we  may update  from  time  to  time,  a  current  version  of  which  is  available here <NavLink to={COOKIES_ROUTE}><u>Privacy Policy</u></NavLink>.<br/><br/>

            By accessing the Site, you agree to the Terms and Privacy Policy. If you do not agree to the Terms and Privacy Policy, you should exit our Site and not use the Services.<br/><br/>

            We  may  revise  the  Terms  at  any  time  without  notice  by  updating  this  Site.  All  updates  to  the Terms  will  be  posted  on  this  page.  You  are  bound  by  any  revisions  or  updates.  You  should periodically  visit  these  Terms  to  review  the  current  terms  that  apply  to  your  use  of  our  Site.  Any use of the Site by you after our publication of any such changes shall constitute your acceptance of these  Terms  as  modified.  We  may,  at  our  sole  discretion  and  at  any  time,  discontinue  providing the Site or the Services or any part of thereof without notice.<br/><br/>
            Use of and access to the Site is void where prohibited by law. By using the Site, you represent and warrant  that  you  are  18  years  of  age  or  older,  and  that  your  use  of  the  Site  does  not  violate  any applicable law or regulation or any obligation.<br/><br/>

            <div className='point'>The Services and Intellectual Property</div>
            The  Services  are  intend  for  the  purposes  listed  in  the  Site.  You  may  not  use  the  Services  for  any other purpose and your use of the Service should align with all applicable laws.<br/><br/>
            Without   derogating   from   the   generality   of   the   above,   The   Company   owns   (or   has   valid authorizations  or  licenses  required  for)  the  Site,  as  well  as  the  materials  provided  on  this  Site (including  without  limitation,  the  Services),  including  all  worldwide  intellectual  property  rights  in the Site and the Services, and the trademarks, service marks, and logos contained therein. Except as  expressly  permitted  herein,  you  may  not  copy,  further  modify,  duplicate,  distribute,  display, perform, sublicense, republish, retransmit, reproduce, create derivative works of, transfer, sell or otherwise  use  the  Site  or  any  content  appearing  on  the  Site,  including  without  limitation,  the Services.  You  will  not  remove,  alter  or  conceal  any  copyright,  trademark,  service  mark  or  other proprietary  rights  notices  incorporated  in  the  Site  or  the  Services.  All  trademarks  are  trademarks or registered trademarks of their respective owners. Nothing in these Terms grants you any right to use any trademark, service mark, logo, or trade name of the Company or any third party. You  may  not  or  attempt  to  (a)  decipher,  decompile,  disassemble,  or  reverse-engineer  any  of  the software  used  to  provide  the  Site  or  the  Services;  (b)  circumvent,  disable,  or  otherwise  interfere with  security-related  features  of  the  Site  or  Services  or  features  that  prevent  or  restrict  use  or copying  of  any  content;  (c)  use  any  robot,  spider,  site  search  or  retrieval  service,  or  any  other manual  or  automatic  device  or  process  to  retrieve,  index,  data-mine,  or  in  any  way  reproduce  or circumvent the navigational structure or presentation of the Site or Service; or (d) harvest, collect or mine information about users of the Site or Services.<br/><br/>

            <div className='point'>Disclaimers & Disclaimer of Warranty</div>
            No  representations  or  warranties  express  or  implied,  are  given  regarding  the  legal  or  other consequences  resulting  from  the  use  of  our  Site  or  Services.  The  information  contained  in  this  is provided for general information only.<br/><br/>
            Your use of the Site or Services is at your sole discretion. The Site and Services are provided on an “AS-IS”  and  “AS  AVAILABLE”  basis  without  warranties  of  any  kind  from  the  Company.  THE COMPANY   EXPRESSLY   DISCLAIMS   ALL   WARRANTIES   OF   ANY   KIND,   EXPRESS,   IMPLIED   OR STATUTORY,   RELATING   TO   THE   SITE   OR   SERVICES,   INCLUDING   WITHOUT   LIMITATION   THE WARRANTIES  OF  TITLE,  MERCHANTABILITY,  FITNESS  FOR  A  PARTICULAR  PURPOSE,  OR  NON-INFRINGEMENT.   THE   COMPANY   DISCLAIMS   ANY   WARRANTIES,   EXPRESS   OR   IMPLIED,   (I) REGARDING THE SECURITY, ACCURACY, RELIABILITY, TIMELINESS AND PERFORMANCE OF THE SITE OR  SERVICES;  OR  (II)  THAT  THE  SITE  WILL  BE  ERROR-FREE  OR  THAT  ANY  ERRORS  WILL  BE CORRECTED;  OR  (III)  REGARDING  THE  PERFORMANCE  OF  OR  ACCURACY,  QUALITY,  CURRENCY, COMPLETENESS OR USEFULNESS OF ANY INFORMATION OR SERVICES PROVIDED BY THE SITE. THE COMPANY MAKES NO COMMITMENT TO UPDATE THE INFORMATION CONTAINED IN THE SITE.<br/><br/>

            If you choose to rely on information from the Site, you do so solely at your own risk. Some states or  jurisdictions  do  not  allow  the  exclusion  of  certain  warranties.  Accordingly,  some  of  the  above exclusions may not apply to you.<br/><br/>

            <div className='point'>Limitation of Liability</div>
            ...
            {/*            <div className='point'>1. User Obligation</div>*/}
...
{/*            <div className='point'>3. Data Submissions</div>*/}
...
{/*            <div className='point'>4. Data collection and use</div>*/}
...
{/*            <div className='point'>5. Copyright and Other Intellectual Property</div>*/}
...
{/*            <div className='point'>6. Third Party Sites / Links</div>*/}
...
{/*            <div className='point'>7. Disclaimer / Limitation of Liability</div>*/}
...
{/*            <div className='point'>8. Indemnity</div>*/}
...
{/*            <div className='point'>9. Law and Jurisdiction</div>*/}
