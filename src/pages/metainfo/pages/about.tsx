    ...
    return (
        <div className='about'>
            ...
            <div className="about__text">
                <p>The African Connection (TAC) is an independent media outlet focusing on African geopolitics and security.</p>

                <p>We shine an analytical light on latest news, publish reports, as well as in-depth investigations, in order to shed more light on the continent and bring attention to it to a wider audience.</p>
